      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="group relative bg-gradient-to-br from-gray-800 to-gray-900 border-2 border-purple-500/50 rounded-2xl p-6 sm:p-8 shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 hover:border-purple-400 max-w-sm w-full"
          >
